...
#KEY FEATURES
 -> ##Customer Account Management -- Create new bank accounts
                                   Store customer details securely
                                   Update and manage account information

-> ##Transaction Management -- Deposit money into accounts
                             Withdraw money with balance validation
                             Check account balance in real time

-> ##System Functionality -- Menu-driven interface for easy navigation
                           Proper validation to prevent invalid operations
                           Structured and readable codebase

-> ##Security & Reliability -- Controlled access to account operations
